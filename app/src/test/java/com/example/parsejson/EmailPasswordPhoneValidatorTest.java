...
import com.example.parsejson.OtherPackage.EmailPasswordPhoneValidator;
...
public class EmailPasswordPhoneValidatorTest {
    ...
    @Test
    public void passwordValidator_InvalidPasswordTooMuch_ReturnsTrue() {
        assertTrue(EmailPasswordPhoneValidator.getInstance().isValidPassword("1234567qwertyuQWERTYU"));
    }

    @Test
    public void passwordValidator_InvalidPasswordLengthSevenChars_ReturnsTrue() {
        assertTrue(EmailPasswordPhoneValidator.getInstance().isValidPassword("Abcdefg"));
    }
    ...
    @Test
    public void phoneNumbersValidator_InvalidPhoneNumbersPhoneNumbersShort_ReturnsFalse() {
        assertFalse(EmailPasswordPhoneValidator.getInstance().isValidPhoneNumber("054544690"));
    }
